...
## Purpose
Defines how backend repositories issue database queries: static queries are type-safe generated Go from SQL (sqlc), dynamic queries go through a small unit-tested SQL builder rather than hand-rolled string concatenation, and tenant scoping is preserved throughout.
