 ...
 * and surface a toast. Typed errors (NetworkError, AuthError) map to
 * dedicated i18n keys so the message is clean and localised. Other errors
 * append the raw message for debuggability.
