...
/** Per-team push-category toggles, shown in ProfileSheet once the browser has an active push
 * subscription -- extracted to its own component to keep ProfileSheet's own complexity down. */
