...
func (s *Store) InsertEvent(ctx context.Context, teamID string, ev spielerplus.Event) (id string, err error) {
	...
	_, err = s.Pool.Exec(ctx, `
		INSERT INTO events (id, team_id, type, title, date, location, start_time, end_time, created_at, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8, now(), now())
	`, newID, teamID, eventType(ev.Type), ev.Title, ev.Start.Format("2006-01-02"), nullIfEmpty(ev.Location), startTime, endTime)
	if err != nil {
